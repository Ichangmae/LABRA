  ...
  <div class="container mt-4">
    ...
    <form method="post" action="crud.php">
      <div class="form-group text" >
        <label for="appointmentProcedureID">Appointment Procedure ID:</label>
        <input type="text" class="form-control" id="appointmentProcedureID" name="appointmentProcedureID" required>
      </div>
    ...
    <table class="table mt-4">
      <thead>
        <tr>
          <th>Appointment Procedure ID</th>
